...
const DefaultLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50/50">
      {/* Sidebar */}
      <aside className={`bg-white border-r border-gray-100 flex flex-col fixed h-full transition-all duration-300 ${isSidebarCollapsed ? 'w-20' : 'w-72'}`}>
        {/* Logo section */}
        <div className={`flex items-center border-b border-gray-50 ${isSidebarCollapsed ? 'px-4 py-6 justify-center' : 'px-8 py-6'}`}>
        ...
        <button
          ...
          className="absolute -right-4 top-20 bg-white border border-gray-100 rounded-full p-1.5 hover:bg-gray-50 transition-colors shadow-sm"
        >
          <svg
        ...
        {/* Navigation Links */}
        <nav className={`flex-1 py-8 space-y-1.5 ${isSidebarCollapsed ? 'px-3' : 'px-4'}`}>
          <Link
            to="/dashboard"
          ...
          >
            ...
            {!isSidebarCollapsed && <span className="text-sm">Students</span>}
          </Link>
        ...
        <div className="border-t border-gray-50 p-4">
          <div className={`bg-gray-50/50 rounded-xl p-4 ${isSidebarCollapsed ? 'flex justify-center' : ''}`}>
            <div
